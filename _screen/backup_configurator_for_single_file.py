...
class BackupConfiguratorForSingleFile(RootScreen):
    """

    BackupConfiguratorForSingleFile is a screen that prompts the user into entering the absolute path for the target file.
    When done, the target file is backed up by the backup service upon its modification detection.
    ...
    def execute() -> None:
        ...
        BackupConfiguratorForSingleFile._LOCALE = LanguageSelector.get_language_dict()
        
        # Take input from the user.
        BackupConfiguratorForSingleFile._take_input()
        
        # Navigate to the previous screen.
        BackupConfiguratorForSingleFile._navigate_backward()
    ...
    def _display_screen() -> None:
        ...
        SCREEN_MAIN_MENU = BackupConfiguratorForSingleFile._LOCALE[String.LANGUAGE_KEY_SCREEN_MAIN_MENU]
        SCREEN_BACKUP_CONFIGURATOR = BackupConfiguratorForSingleFile._LOCALE[String.LANGUAGE_KEY_SCREEN_BACKUP_CONFIGURATOR]
        SCREEN_BACKUP_CONFIGURATOR_FOR_SINGLE_FILE = BackupConfiguratorForSingleFile._LOCALE[String.LANGUAGE_KEY_SCREEN_BACKUP_CONFIGURATOR_FOR_SINGLE_FILE]
        DESCRIBE_BACKUP_CONFIGURATOR_FOR_FILE = BackupConfiguratorForSingleFile._LOCALE[String.LANGUAGE_KEY_DESCRIBE_BACKUP_CONFIGURATOR_FOR_FILE]
        ...
        print(f'{COLOR_PURPLE} > {COLOR_END}', end='')
        print(f'{COLOR_PURPLE}[2]{COLOR_END} {COLOR_YELLOW}{SCREEN_BACKUP_CONFIGURATOR_FOR_SINGLE_FILE}{COLOR_END}', end='\n')

        # Print the screen main content.
        print(f'{COLOR_PURPLE}{SEPARATOR}{COLOR_END}', end='\n\n')
        print(f'{COLOR_YELLOW}{DESCRIBE_BACKUP_CONFIGURATOR_FOR_FILE}{COLOR_END}', end='\n\n')
        print(f'{COLOR_PURPLE}{SEPARATOR}{COLOR_END}', end='')
    ...
    def _is_input_valid(user_input: str) -> bool:
        ...
        # Assert if user input is equal to '0' or if user input is a valid path for a file.
    ...
    def _take_input() -> None:
        ...
        PROMPT_BACKUP_CONFIGURATOR_FOR_SINGLE_FILE = BackupConfiguratorForSingleFile._LOCALE[String.LANGUAGE_KEY_PROMPT_BACKUP_CONFIGURATOR_FOR_SINGLE_FILE]
        ...
        while True:
            ...
            try:
                # Display the screen.
                BackupConfiguratorForSingleFile._display_screen()
                
                # Read user input from the console window.
                user_input = input(f'{COLOR_BLUE}{PROMPT_BACKUP_CONFIGURATOR_FOR_SINGLE_FILE}{COLOR_END}')

                # Update user input after removing the trailing slash.
                user_input = PathUtils.remove_trailing_slash_from_path(user_input)

                # If user input is valid:
                if BackupConfiguratorForSingleFile._is_input_valid(user_input):
                    # Process user input.
                    BackupConfiguratorForSingleFile._process_input(user_input)
