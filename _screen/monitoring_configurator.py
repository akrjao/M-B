...
class MonitoringConfigurator(RootScreen):
    """
    
    MonitoringConfigurator is a screen that enables the user to either select to:
        Start monitoring a directory.
        Start monitoring a single file.
        Remove a directory from being monitored.
        Remove a single file from being monitored.
    ...
    def execute() -> None:
        ...
        MonitoringConfigurator._LOCALE = LanguageSelector.get_language_dict()
        
        # Take input from the user.
        MonitoringConfigurator._take_input()
    ...
    def _display_screen() -> None:
        ...
        SCREEN_MAIN_MENU = MonitoringConfigurator._LOCALE[String.LANGUAGE_KEY_SCREEN_MAIN_MENU]
        SCREEN_MONITORING_CONFIGURATOR = MonitoringConfigurator._LOCALE[String.LANGUAGE_KEY_SCREEN_MONITORING_CONFIGURATOR]
        OPEN_MONITORING_CONFIGURATOR_FOR_DIRECTORY = MonitoringConfigurator._LOCALE[String.LANGUAGE_KEY_OPEN_MONITORING_CONFIGURATOR_FOR_DIRECTORY]
        OPEN_MONITORING_CONFIGURATOR_FOR_SINGLE_FILE = MonitoringConfigurator._LOCALE[String.LANGUAGE_KEY_OPEN_MONITORING_CONFIGURATOR_FOR_SINGLE_FILE]
        OPEN_MONITORING_REMOVER_FOR_DIRECTORY = MonitoringConfigurator._LOCALE[String.LANGUAGE_KEY_OPEN_MONITORING_REMOVER_FOR_DIRECTORY]
        OPEN_MONITORING_REMOVER_FOR_SINGLE_FILE = MonitoringConfigurator._LOCALE[String.LANGUAGE_KEY_OPEN_MONITORING_REMOVER_FOR_SINGLE_FILE]
        GO_BACKWARD = MonitoringConfigurator._LOCALE[String.LANGUAGE_KEY_GO_BACKWARD]
        ...
        print(f'{COLOR_PURPLE}{SEPARATOR}{COLOR_END}', end='\n\n')
        print(f'{COLOR_GREEN}[1] {COLOR_END}{COLOR_YELLOW}{OPEN_MONITORING_CONFIGURATOR_FOR_DIRECTORY}{COLOR_END}', end='\n\n')
        print(f'{COLOR_GREEN}[2] {COLOR_END}{COLOR_YELLOW}{OPEN_MONITORING_CONFIGURATOR_FOR_SINGLE_FILE}{COLOR_END}', end='\n\n')
        print(f'{COLOR_PURPLE}{SEPARATOR}{COLOR_END}', end='\n\n')
        print(f'{COLOR_GREEN}[3] {COLOR_END}{COLOR_YELLOW}{OPEN_MONITORING_REMOVER_FOR_DIRECTORY}{COLOR_END}', end='\n\n')
        print(f'{COLOR_GREEN}[4] {COLOR_END}{COLOR_YELLOW}{OPEN_MONITORING_REMOVER_FOR_SINGLE_FILE}{COLOR_END}', end='\n\n\n\n')
    ...
    def _navigate_forward(user_input: int) -> None:
        ...
        match user_input:
            ...
            case 1:
                # Import the respective screen module.
                from _screen.monitoring_configurator_for_directory import MonitoringConfiguratorForDirectory
                
                # Execute it.
                MonitoringConfiguratorForDirectory.execute()
            
            # user input is equal to 2:
            case 2:
                # Import the respective screen module.
                from _screen.monitoring_configurator_for_single_file import MonitoringConfiguratorForSingleFile
                
                # Execute it.
                MonitoringConfiguratorForSingleFile.execute()
            
            # user input is equal to 3:
            case 3:
                # Import the respective screen module.
                from _screen.monitoring_remover_for_directory import MonitoringRemoverForDirectory
            ...
            case 4:
                # Import the respective screen module.
                from _screen.monitoring_remover_for_single_file import MonitoringRemoverForSingleFile
    ...
    def _process_input(user_input: int) -> None:
        ...
        if user_input == 0:
            ...
            MonitoringConfigurator._navigate_backward()
        
        # If user input is not equal to 0:
        else:
            # Navigate to the next screen based on user input.
            MonitoringConfigurator._navigate_forward(user_input)
    ...
    def _take_input() -> None:
        ...
        PROMPT_MONITORING_CONFIGURATOR = MonitoringConfigurator._LOCALE[String.LANGUAGE_KEY_PROMPT_MONITORING_CONFIGURATOR]
        ...
        while True:
            ...
            try:
                # Display the screen.
                MonitoringConfigurator._display_screen()
                
                # Read user input from the console window.
                user_input = int(input(f'{COLOR_BLUE}{PROMPT_MONITORING_CONFIGURATOR}{COLOR_END}'))
                
                # If user input is valid:
                if MonitoringConfigurator._is_input_valid(user_input):
                    # Process user input.
                    MonitoringConfigurator._process_input(user_input)
