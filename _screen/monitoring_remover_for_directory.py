...
class MonitoringRemoverForDirectory(RootScreen):
    """
    
    MonitoringRemoverFordirectory is a screen that enables the user to remove a target directory from the monitoring service.
    When done, the monitoring service no longer tracks access or modification of files within the target directory.
    ...
    def execute() -> None:
        ...
        MonitoringRemoverForDirectory._LOCALE = LanguageSelector.get_language_dict()

        # Take input from the user.
        MonitoringRemoverForDirectory._take_input()
    ...
    def _display_screen(phase: str) -> None:
        ...
        SCREEN_MAIN_MENU = MonitoringRemoverForDirectory._LOCALE[String.LANGUAGE_KEY_SCREEN_MAIN_MENU]
        SCREEN_MONITORING_CONFIGURATOR = MonitoringRemoverForDirectory._LOCALE[String.LANGUAGE_KEY_SCREEN_MONITORING_CONFIGURATOR]
        SCREEN_MONITORING_REMOVER_FOR_DIRECTORY = MonitoringRemoverForDirectory._LOCALE[String.LANGUAGE_KEY_SCREEN_MONITORING_REMOVER_FOR_DIRECTORY]
        DESCRIBE_MONITORING_REMOVER_FOR_DIRECTORY_ONE = MonitoringRemoverForDirectory._LOCALE[String.LANGUAGE_KEY_DESCRIBE_MONITORING_REMOVER_FOR_DIRECTORY_ONE]
        DESCRIBE_MONITORING_REMOVER_FOR_DIRECTORY_TWO = MonitoringRemoverForDirectory._LOCALE[String.LANGUAGE_KEY_DESCRIBE_MONITORING_REMOVER_FOR_DIRECTORY_TWO]
        ...
        print(f'{COLOR_PURPLE} > {COLOR_END}', end='')
        print(f'{COLOR_PURPLE}[3]{COLOR_END} {COLOR_YELLOW}{SCREEN_MONITORING_REMOVER_FOR_DIRECTORY}{COLOR_END}', end='\n')
        print(f'{COLOR_PURPLE}{SEPARATOR}{COLOR_END}', end='\n')

        # If phase is equal to phase one:
        if phase == String.LITERAL_PHASE_ONE:
            # Print the description for the monitoring remover for directory; for phase one.
            print(f'\n{COLOR_YELLOW}{DESCRIBE_MONITORING_REMOVER_FOR_DIRECTORY_ONE}{COLOR_END}', end='\n\n')
            print(f'{COLOR_PURPLE}{SEPARATOR}{COLOR_END}', end='\n\n')
        ...
        # If phase is not equal to phase one:
            ...
            # Print the description for the monitoring remover for directory; for phase two.
            print(f'\n{COLOR_YELLOW}{DESCRIBE_MONITORING_REMOVER_FOR_DIRECTORY_TWO}{COLOR_END}', end='\n\n')
            print(f'{COLOR_PURPLE}{SEPARATOR}{COLOR_END}', end='')
    ...
    def _is_input_valid(phase: str, user_input: Union[int, str]) -> bool:
        ...
        # If phase is equal to phase one:
        if phase == String.LITERAL_PHASE_ONE:
            # Assert if user input is equal to 0 or if user input is in the list of ids of monitored directories.
    ...
    def _process_input(phase: str, user_input: Union[int, str]) -> None:
        ...
        if phase == String.LITERAL_PHASE_ONE:
            ...
            if user_input == 0:
                ...
                MonitoringRemoverForDirectory._navigate_backward()
            
            # If user input is not equal to 0:
            else:
                # Delete the respective monitoring json entry based on user input.
                MonitoringManager.delete_monitoring_json_entry(user_input)
        ...
        # If phase is not equal to phase one:
            ...
            if user_input.lower() == String.LITERAL_YES:
               ...
               MonitoringRemoverForDirectory.execute()
    ...
    def _take_input() -> None:
        ...
        # Initialize various label constants based on the selected language.
        PROMPT_MONITORING_REMOVER_FOR_DIRECTORY_ONE = MonitoringRemoverForDirectory._LOCALE[String.LANGUAGE_KEY_PROMPT_MONITORING_REMOVER_FOR_DIRECTORY_ONE]
        PROMPT_MONITORING_REMOVER_FOR_DIRECTORY_TWO = MonitoringRemoverForDirectory._LOCALE[String.LANGUAGE_KEY_PROMPT_MONITORING_REMOVER_FOR_DIRECTORY_TWO]
        ...
        while True:
            ...
            try:
                ...
                MonitoringRemoverForDirectory._display_screen(String.LITERAL_PHASE_ONE)
                
                # Read user input from the console window; for phase one.
                user_input = int(input(f'{COLOR_BLUE}{PROMPT_MONITORING_REMOVER_FOR_DIRECTORY_ONE}{COLOR_END}'))
                
                # If user input is valid; for phase one:
                if MonitoringRemoverForDirectory._is_input_valid(String.LITERAL_PHASE_ONE, user_input):
                    # Process user input; for phase one.
                    MonitoringRemoverForDirectory._process_input(String.LITERAL_PHASE_ONE, user_input)
                    
                    # Loop indefinitely; for phase two.
                    while True:
                        # Display the screen; for phase two.
                        MonitoringRemoverForDirectory._display_screen(String.LITERAL_PHASE_TWO)
                        
                        # Read user input from the console window; for phase two.
                        user_input = input(f'{COLOR_BLUE}{PROMPT_MONITORING_REMOVER_FOR_DIRECTORY_TWO}{COLOR_END}')
                        
                        # If user input is valid; for phase two:
                        if MonitoringRemoverForDirectory._is_input_valid(String.LITERAL_PHASE_TWO, user_input):
                            # Process user input; for phase two.
                            MonitoringRemoverForDirectory._process_input(String.LITERAL_PHASE_TWO, user_input)
