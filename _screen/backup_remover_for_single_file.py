...
class BackupRemoverForSingleFile(RootScreen):
    """
    
    BackupRemoverForSingleFile is a screen that enables the user to remove a target file from the backup service.
    When done, the backup service no longer backs up the target file upon modification detection.
    ...
    def execute() -> None:
        ...
        BackupRemoverForSingleFile._LOCALE = LanguageSelector.get_language_dict()
        
        # Take input from the user.
        BackupRemoverForSingleFile._take_input()
    ...
    def _display_screen(phase: str) -> None:
        ...
        SCREEN_MAIN_MENU = BackupRemoverForSingleFile._LOCALE[String.LANGUAGE_KEY_SCREEN_MAIN_MENU]
        SCREEN_BACKUP_CONFIGURATOR = BackupRemoverForSingleFile._LOCALE[String.LANGUAGE_KEY_SCREEN_BACKUP_CONFIGURATOR]
        SCREEN_BACKUP_REMOVER_FOR_SINGLE_FILE = BackupRemoverForSingleFile._LOCALE[String.LANGUAGE_KEY_SCREEN_BACKUP_REMOVER_FOR_SINGLE_FILE]
        DESCRIBE_BACKUP_REMOVER_FOR_SINGLE_FILE_ONE = BackupRemoverForSingleFile._LOCALE[String.LANGUAGE_KEY_DESCRIBE_BACKUP_REMOVER_FOR_SINGLE_FILE_ONE]
        DESCRIBE_BACKUP_REMOVER_FOR_SINGLE_FILE_TWO = BackupRemoverForSingleFile._LOCALE[String.LANGUAGE_KEY_DESCRIBE_BACKUP_REMOVER_FOR_SINGLE_FILE_TWO]
        ...
        print(f'{COLOR_PURPLE} > {COLOR_END}', end='')
        print(f'{COLOR_PURPLE}[4]{COLOR_END} {COLOR_YELLOW}{SCREEN_BACKUP_REMOVER_FOR_SINGLE_FILE}{COLOR_END}', end='\n')
        print(f'{COLOR_PURPLE}{SEPARATOR}{COLOR_END}', end='\n')

        # If phase is equal to phase one:
        if phase == String.LITERAL_PHASE_ONE:
            # Print the description of the backup remover for single file; for phase one.
            print(f'\n{COLOR_YELLOW}{DESCRIBE_BACKUP_REMOVER_FOR_SINGLE_FILE_ONE}{COLOR_END}', end='\n\n')
            print(f'{COLOR_PURPLE}{SEPARATOR}{COLOR_END}', end='\n\n')
            
            # Display the list of backed up files with their attributes.
            BackupManager.display_backedup_files()
        ...
        # If phase is not equal to phase one:
            ...
            # Print the description of the backup remover for single file; for phase two.
            print(f'\n{COLOR_YELLOW}{DESCRIBE_BACKUP_REMOVER_FOR_SINGLE_FILE_TWO}{COLOR_END}', end='\n\n')
            print(f'{COLOR_PURPLE}{SEPARATOR}{COLOR_END}', end='')
    ...
    def _is_input_valid(phase: str, user_input: str) -> bool:
        ...
        # If phase is equal to phase one:
        if phase == String.LITERAL_PHASE_ONE:
            # Assert if user input is equal to '0' or if user input is in the list of ids of backed up files.
            return user_input == String.LITERAL_ZERO or int(user_input) in BackupManager.get_ids_of_backedup_files()
    ...
    def _process_input(phase: str, user_input: str) -> None:
        ...
        Description:
            Checks the value of phase and user_input to invoke other methods based on the phase of this screen.
        ...
        if phase == String.LITERAL_PHASE_ONE:
            ...
            if user_input == String.LITERAL_ZERO:
                ...
                BackupRemoverForSingleFile._navigate_backward()
    ...
    def _take_input() -> None:
        ...
        # Initialize various label constants based on the selected language.
        PROMPT_BACKUP_REMOVER_FOR_SINGLE_FILE_ONE = BackupRemoverForSingleFile._LOCALE[String.LANGUAGE_KEY_PROMPT_BACKUP_REMOVER_FOR_SINGLE_FILE_ONE]
        PROMPT_BACKUP_REMOVER_FOR_SINGLE_FILE_TWO = BackupRemoverForSingleFile._LOCALE[String.LANGUAGE_KEY_PROMPT_BACKUP_REMOVER_FOR_SINGLE_FILE_TWO]
        ...
        while True:
            ...
            try:
                ...
                BackupRemoverForSingleFile._display_screen(String.LITERAL_PHASE_ONE)
                
                # Read user input from the console window; for phase one.
                user_input = input(f'{COLOR_BLUE}{PROMPT_BACKUP_REMOVER_FOR_SINGLE_FILE_ONE}{COLOR_END}')
                
                # If user input is valid; for phase one:
                if BackupRemoverForSingleFile._is_input_valid(String.LITERAL_PHASE_ONE, user_input):
                    # Process user input; for phase one.
                    BackupRemoverForSingleFile._process_input(String.LITERAL_PHASE_ONE, user_input)
                    
                    # Loop indefinitely; for phase two.
                    while True:
                        # Display the screen; for phase two.
                        BackupRemoverForSingleFile._display_screen(String.LITERAL_PHASE_TWO)
                        
                        # Read user input from the console window; for phase two.
                        user_input = input(f'{COLOR_BLUE}{PROMPT_BACKUP_REMOVER_FOR_SINGLE_FILE_TWO}{COLOR_END}')
                        
                        # If user input is valid; for phase two:
                        if BackupRemoverForSingleFile._is_input_valid(String.LITERAL_PHASE_TWO, user_input):
                            # Process user input; for phase two.
                            BackupRemoverForSingleFile._process_input(String.LITERAL_PHASE_TWO, user_input)
